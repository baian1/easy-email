import { useBlock, useFocusIdx } from '@shining-it/easy-email-editor';
import { Collapse, Grid, Switch } from '@arco-design/web-react';
import { AdvancedBlock, AdvancedType } from '@shining-it/easy-email-core';
...
export function Iteration() {
  ...
  const iteration = focusBlock?.data.value?.iteration;
